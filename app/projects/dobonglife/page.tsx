...
function DiagramFigure({
  ...
  return (
    <figure className="overflow-hidden rounded-xl border border-[#e5e5e5] bg-white">
      <div className="bg-[#fafafa] px-4 py-6 sm:px-8">
        <ExpandableImage
          src={src}
          alt={alt}
          width={width}
          height={height}
          unoptimized
          wrapperClassName="mx-auto block w-full max-w-[860px] overflow-hidden border border-[#e5e5e5] bg-white"
          className="h-auto w-full object-contain"
        />
      </div>
      <figcaption className="border-t border-[#e5e5e5] px-5 py-4 text-sm text-[#737373]">
        {caption}
      </figcaption>
    </figure>
  );
    ...
    <div className="min-h-screen bg-white text-black">
      <main className="mx-auto max-w-[760px] px-5 pt-10 pb-28 sm:px-6">
        ...
        <header className="flex flex-col gap-8 mt-16 pt-10 text-center">
          ...
          <section className="mt-16 grid grid-cols-3 items-stretch">
            ...
            <div className="grid grid-rows-[auto_1fr]">
              ...
              <p className="mt-3 flex min-h-10 items-center justify-center text-sm font-medium text-black">
                {projectInfo.affiliation} / {projectInfo.position}
              </p>
            </div>
            <div className="grid grid-rows-[auto_1fr]">
              <p className="text-xs font-medium uppercase tracking-[0.18em] text-[#737373]">
        ...
        <section id="overview" className="scroll-mt-12 pt-24">
          ...
          <p className="mt-6 text-base font-normal leading-relaxed tracking-normal text-[#737373]">
            ...
            위한 관광 정보 안내 서비스입니다. 스토리텔링 기반 여행 코스,
            맛집 정보,{" "}
            <strong className="font-medium text-black">
              지역 소상공인 연계 할인 쿠폰 발행 및 사용 기능을
            </strong>
            제공하며, 현재{" "}
            <strong className="font-medium text-black">
              플레이스토어와 앱스토어에 출시되어
          ...
          <div className="border-b border-[#e5e5e5]">
            <div className="gap-5 py-6 md:gap-8">
              ...
              <ul className="mt-4 grid gap-2">
                <li className="text-sm font-normal leading-relaxed tracking-normal text-[#737373]">
            ...
            <div className="gap-5 border-t border-[#e5e5e5] py-6">
              <h3 className="text-[18px] font-medium leading-[1.56] tracking-normal text-black">
        ...
        <section id="infrastructure" className="scroll-mt-12 pt-16">
          ...
          <div className="border-b border-[#e5e5e5]">
            <article className="py-6">
              ...
              <p className="mt-4 text-sm font-normal leading-relaxed tracking-normal text-[#737373]">
            ...
            <article className="border-t border-[#e5e5e5] py-6">
              <h3 className="text-[18px] font-medium leading-[1.56] tracking-normal text-black">
              ...
              <div className="mt-6 grid gap-6">
                <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-4 inline-flex text-xs font-semibold text-[#000000] underline underline-offset-4"
                  >
