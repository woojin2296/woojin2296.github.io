...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-[1080px] mx-auto px-6 pt-16 sm:px-10 lg:px-24">
        <header className="flex flex-col gap-4 py-16 items-left">
        ...
        <section id="about" className="flex flex-col items-left py-16 gap-16">
          ...
          <div className="flex flex-col">
            {keyProjects.map((project, index) => (
              <Link
                ...
                className="group block cursor-pointer p-7 transition-colors hover:bg-white/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[#0c0c0c] border-b-[1px] border-b-[#c4c0b8]"
              >
                <div>
                  ...
                  {project.summary.map((text, index) => (
                    <p key={index} className="text-sm text-[#666] mb-1">
                      - {text}
                    </p>
                  ))}
                  <div className="flex flex-wrap gap-2 mt-3">
                    {project.techStack
                      ...
                      .map((skill, index) => (
                        <span
                          key={index}
                          className={`text-xs px-3 py-1 font-medium border ${skill.primary ? "bg-[#1a1a1a] text-white border-[#1a1a1a]" : "border-[#ccc] text-[#555]"}`}
                        >
                          {skill.name}
                        </span>
                      ))}
