  ...
  return (
    <main className="flex mx-auto max-w-3xl px-12 flex-col mt-14 pb-28">
      ...
      <section className="mt-10">
        ...
        <div className="grid grid-cols-[1fr_2fr] gap-2 sm:grid-cols-[1fr_2fr_1fr_2fr]">
      ...
      <section className="mt-10">
        ...
        <div className="grid gap-2">
          <article className="grid gap-1 sm:grid-cols-[110px_1fr]">
            <div className="flex flex-col items-start gap-2">
              <p className="text-[#5a6775]">인턴 사원</p>
              <p className="text-sm text-[#5a6775]">2025.09 ~ 2025.02</p>
            </div>
            <div>
              ...
              <p className="text-[#5a6775]">
                | 리눅스 기반 Qt로 저선량 X-ray 관절염 치료기기(AMUST) GUI
                개발{" "}
              </p>
            </div>
          </article>
          <article className="grid gap-1 pt-6 sm:grid-cols-[110px_1fr]">
            <div className="flex flex-col items-start gap-2">
              <p className="text-[#5a6775]">학부연구생</p>
              <p className="text-sm text-[#5a6775]">2024.01 ~ 2026.02</p>
            </div>
            <div>
              <p className="text-lg font-semibold text-[#111418]">
                순천향대학교 UBICOMP LAB
              ...
              <p className="text-[#5a6775]">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 text-[#2d4cf2] hover:text-[#1d3dcc]"
                >
                  논문 보기
                  <span aria-hidden="true">↗</span>
                </a>
